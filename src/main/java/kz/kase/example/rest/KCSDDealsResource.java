...
public class KCSDDealsResource {
   ...
   public KCSDDealsResource() {
      deals.add(new Deal(30790L, "2025-04-01 14:15:01", "PRIMARY", "ПРОДАЖА", "BOND", "NTK028_2861", "KZ2C00010478", "Национальный банк РК", 100000000L, "98.8062", "%", "9880620000.00", "NOM", 1001, true, false, 1002, true, false));
...
//      deals.add(new Deal(30893L, "2025-04-02 16:17:31", "NTK028_2861", "KZ2C00010478", 27, "15.6500", "98.6773", 96700000L, "980620000.00", "2025-04-06", true));
   ...
   public Response getKcsdDeals(
      @QueryParam("date") 
      @Parameter(
         in = ParameterIn.QUERY, 
         name = "date",
         description = "Дата совершения сделок в формате ISO-8601 {uuuu-MM-dd}. В случае если сделки на указанную дату отсутствует, метод возвращает пустой список. В случае если дата не указана, метод вернет сделки за тот день, когда они регистрировалист в ЦД в последний раз.",
          schema = @Schema(
